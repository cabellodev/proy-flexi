...
<html lang="en">
    <head>
        ...
        <title>Flexitec</title>

        <!-- CSS FILES -->
        <script src="//code.tidio.co/eo9jm6jlys2pjpf5p5pbg7irj8uqb3uo.js" async></script>
        <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
      <!--  <script src="//code.tidio.co/vkcfmrymhiut5kvzbcqyfq23cujxlkzs.js" async></script>-->
        ...
        <nav class="navbar navbar-expand-lg bg-white">
            <div class="container">
             ...
             <a href="#section_1" class="navbar-brand ">
                    <img class="img-fluid" src="<?php echo base_url(); ?>assets/images/logo-flexitec.png" oncontextmenu='return false' ondragstart='return false'
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu keep-open-on-click" aria-labelledby="navbarDropdown">
                              <li><a class="dropdown-item" href="<?php echo base_url(); ?>about">FLEXITEC</a></li>
...
-->
        ...
        <a href="https://wa.me/56947092401" class="btn-wsp"  > <i class="icon-whatsapp"></i></a>
