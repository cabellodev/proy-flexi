<div id="content-wrapper">
  <div class="container-fluid mb-5">
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item active">Home/ Tipo productos</li>
    </ol>

    <div class="card mb-3">
      <div class="card-header">
        <i class="fas fa-table"></i>
         Listado tipo de productos
        <button class="btn btn-secondary float-right" type='button' data-toggle="modal" data-target="#create_supplier_modal" id="btn_create_supplier"><i class="fas fa-plus"></i> Agregar tipo</button>
      </div>
      <div class="card-body">
