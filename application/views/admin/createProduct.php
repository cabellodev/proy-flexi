            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3" style='text-align: center; align-items:center'>
                    ...
                    <div class="input-group" id="frm_imagenPrincipal">
                        <label class="btn btn-primary" id='tr_label_image_header' style='margin:auto;' for="imagenPrincipal">  <i class='fas fa-plus'></i> Seleccionar Imagen</label></br>  
                        <input type="file" id="imagenPrincipal" style="display:none;" accept=".png, .jpg, .jpeg" name="file" />
                        <div class="invalid-feedback"></div>
                    </div>
...
<script src="<?php echo base_url(); ?>assets/js_admin/createProduct.js"></script>
